...
function ModalProductsUser({id,image,product,price, onClick}){
    ...
    return (
            ...
            <>
                <li id={id} className="p-4 border-b-2 m-2 border-gray-300 flex items-center justify-between gap-4 bg-button rounded-md shadow-md hover:shadow-lg transition-shadow duration-300">
                    ...
                    <button onClick={() => onClick(id, price)} className="bg-red-500 text-white p-3 rounded-md hover:bg-red-600 transform hover:scale-105 transition-transform duration-300">
